  ...
  <parametresCas>
    ...
    <parametresPlanimetrageMaillage>
      ...
      <planim>
        <nbPas>37</nbPas>
        <nbZones>1</nbZones>
        <valeursPas>1.5</valeursPas>
        <num1erProf>1</num1erProf>
        <numDerProf>29</numDerProf>
      </planim>
      <maillage>
        ...
        <maillageClavier>
          ...
          <numDerProfPlage>29</numDerProfPlage>
    ...
    <parametresSingularite>
      ...
      <seuils>
        <structureParametresSeuil>
          <nom>Weir graph-Singularity n18</nom>
          <type>4</type>
          <numBranche>1</numBranche>
          <abscisse>400.0</abscisse>
          <coteCrete>270.0</coteCrete>
    ...
    <parametresApportDeversoirs>
      <debitsApports>
        <nbQApport>2</nbQApport>
        <noms>
          <string>Inflow-Singularity n2</string>
          <string>Inflow-Singularity n1</string>
        </noms>
        <numBranche>1 1</numBranche>
        <abscisses>8494.0 7153.0</abscisses>
        <longueurs>0.0 0.0</longueurs>
        <numLoi>4 3</numLoi>
      </debitsApports>
    </parametresApportDeversoirs>
    <parametresCalage>
      <frottement>
        ...
        <absFinZone>20791.28</absFinZone>
        <coefLitMin>28</coefLitMin>
        <coefLitMaj>25</coefLitMaj>
      </frottement>
      <zoneStockage>
    ...
    <parametresLoisHydrauliques>
      ...
      <lois>
        <structureParametresLoi>
          <nom>Downstream-Z</nom>
          <type>2</type>
          <donnees>
            <modeEntree>1</modeEntree>
            <fichier>xjz_1.loi</fichier>
            <uniteTps>-0</uniteTps>
            <nbPoints>-0</nbPoints>
    ...
    <parametresImpressionResultats>
      ...
      <resultats>
        <fichResultat>xjz.opt</fichResultat>
        <postProcesseur>2</postProcesseur>
      </resultats>
      <listing>
        <fichListing>xjz.lis</fichListing>
      </listing>
      <fichReprise>
        <fichRepriseEcr>xjz_ecr.rep</fichRepriseEcr>
      </fichReprise>
      <rubens>
