...
the keyword \telkey{COEFFICIENT FOR DIFFUSION OF TRACERS} which is an
...
coefficient could be programmed directly in the \telfile{CORVIS} subroutine.
...
\section{Limitation with characteristics or Thompson conditions in parallel}
