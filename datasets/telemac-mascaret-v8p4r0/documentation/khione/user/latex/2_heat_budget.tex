...
\phi_B=-0.97\sigma\Big[\ T_{sk}^4-\epsilon_a ( 1+kC^2 ) T_{sk}^4\ \Big]
\end{equation}
...
in which,
\begin{itemize}
	\item $A_s$ is the rate of snowfall over a unit area of surface in kg.m$^{-2}$.s$^{-1}$, equal to $(78.5/86400)\hat{V}^{-2.375}$
