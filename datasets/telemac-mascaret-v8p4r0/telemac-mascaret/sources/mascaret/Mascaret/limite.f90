...
!***********************************************************************
   ...
   ! IF(IS.EQ.894) print*,'CNODE(IS) = ',IS,CNODE(IS)
      ...
      label_ityp : if( ITYP /= 6 )  then
         ...
         label_froude2 : if( FROUDE <= 1.01_DOUBLE ) then
            ...
            30 if( ITYP == 2 ) then
               ...
               ! print*,'IN LIMITE,ITYP=2'
               ! PRINT*,'IS,Y1,S1=',IS,Y1,S1
               ! PRINT*,'FP,Q1,AKIV',FP,Q1,AKIV(IS , S1 , AKGEO , SGEO , NMLARG , Erreur)
            else if (ITYP == 1) then
               !                                     XXXX
