...
\eequ
 ...
 Besides, using the dispersion relation \ref{eq:reldispersion}, it can be demonstrated that:
...
\item  weighting parameter d (corresponding to the keyword \textit{WHITE
...
\item  The coefficient d, corresponding to the keyword \textit{WESTHUYSEN
