...
The numerical schemes implemented for the diffusion being all explicit,
the resolution requires to fullfill a condition on the time step, namely
the Fourier condition (similar to the CFL condition).
