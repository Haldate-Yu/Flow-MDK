...
In the case of coupling \telemac{2D} with \gaia or \sisyphe, the bed roughness
can be determined directly by \gaia if the kyeword
\telkey{COMPUTE BED ROUGHNESS AT SEDIMENT SCALE} is enabled or by \sisyphe
if the keyword \telkey{BED ROUGHNESS PREDICTION} is enabled in the settings file
