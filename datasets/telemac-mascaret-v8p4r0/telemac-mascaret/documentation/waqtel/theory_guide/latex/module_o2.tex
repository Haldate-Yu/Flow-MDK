...
\begin{equation}
  F([O_2]) = k_2 (C_s - [O_2]) -k_1 [L] - k_4 [NH_4] + (P - R) \Delta z - BEN_T.
\end{equation}

with $\Delta z$ half height of the top layer cells (at the free surface).
...
\begin{equation}
  \lambda_1^0 = \frac{k_2 C_s + (P - R) \Delta z - BEN_T}{86400},
\end{equation}
