...
l'Aménagement (CEREMA, France), Centre Européen de Recherche et de Formation
Avancée en Calcul Scientifique (CERFACS, France), Daresbury Laboratory (United
Kingdom), Électricité de France R\&D (EDF, France), and HR Wallingford (United
Kingdom).
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.3]{graphics/telemac-mascaret.png}
