...
is realised in the subroutine \texttt{vectos}.
...
%
The modifications of \texttt{parcom\_comp} are the addition of the
...
Here the assembly is realised with the \texttt{2sum} subroutine
...
from lines \ref{lst:begin_comp} to \ref{lst:end_comp},
...
is computed partially by each subdomain, in function \texttt{p\_dot}, as:
...
computed.
In sequential, function \texttt{dot\_comp} computes such
