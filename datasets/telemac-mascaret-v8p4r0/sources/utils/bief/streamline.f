...
!
     ...
     &  P_MPI_TYPE_FREE,P_MPI_ALLTOALL,P_MPI_ALLTOALLV
      ...
      PRIVATE
!
!     CALLED BY CHARAC (BIEF). CHARAC CALLED BY TELEMAC-2D AND TELEMAC-3D
...
!
      INTEGER, PARAMETER :: MAX_BASKET_SIZE=25 ! LARGE
!
...
!
      IF(.NOT.ADD) THEN
        ...
        IF(NSPMAX.GT.1) WRITE(LU,*) 'NUMBER OF SUB-ITERATIONS :',NSPMAX
      ENDIF
!
...
!
     ...
     &      'IELM: ',IELM
        ...
        ENDIF
!
        WRITE(LU,*) 'USING STREAMLINE VERSION '//TRIM(VERSION)//
     &              ' FOR CHARACTERISTICS'
!
...
!
     ...
     &                 +MESH%Z%R(N6)*SHP3)*SHZ
        ...
        ENDIF
!
      ELSEIF(ELT.EQ.0) THEN
!       ABR: IN CASE ELT IS NEGATIVE, WHICH MEANS THAT THE PARTICLE HAS
!       PASSED AN OPEN BOUNDARY, THESE PARTICLES DO NOT NEED TO BE ADDED
!       AGAIN, BUT SHOULD JUST BE IGNORED.
!       MAY LEAD TO A BUG WHEN THE PARTICLES THAT MOVE THROUGH AN OPEN
!       BOUNDARY DO THAT ON ANOTHER SUBDOMAIN!
!
!       FOR CHECKING THAT A PARTICLE IS NOT ADDED TO SEVERAL SUBDOMAINS
!
        IF(NCSIZE.GT.1) THEN
