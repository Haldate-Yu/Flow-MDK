   ...
   if( ( ITYP == 3 ) .or. ( ITYP == 4 ) ) then
      ...
      if( ( HDEV >= EPS3 ) .or. ( debit > 0.d0 ) ) then
         ...
         if( SD >= .1_DOUBLE ) then
      	 ...
      	 !print*, 'QG, SG, QDEV, PRG, PRD', QG, SG, QDEV, PRG, PRD
